...
export function MonthlyClosing({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-semibold text-slate-700 mb-3">KPIs do Mês</h3>
      ...
      <div className="space-y-3 pt-2 border-t border-slate-100">
        <div>
          <label htmlFor="closing-notes" className="block text-sm font-medium text-slate-700 mb-1">
