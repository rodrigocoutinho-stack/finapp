...
function DiffBadge({
  ...
  // Receita/Investimento: positive diff is good (earned/allocated more than expected)
  // Despesa: positive diff is bad (spent more than expected)
  const isGood = type === "receita" || type === "investimento" ? diff >= 0 : diff <= 0;
